...
function showText(a) {
	var b = {
		...
		gameover: "<div class='centeredHeader unselectable' style='color: #2C3E50;font-weight: bold;font-size: 3rem;'> Game Over</div><div style='color: #2C3E50;margin-top: 5%;font-size: 2.5rem;'>您的得分</div><div style='font-size: 6rem;color: #2C3E50;'>"+ score +"</div>"
	};
